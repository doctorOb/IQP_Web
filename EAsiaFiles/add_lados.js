function add_returnToLados(id){
	...
	if(id == 'topbar'){
		...
		toLados.innerHTML = '<td><a href="http://www.wpi.edu/academics/me/IMDC/" title="iMdc" target="_parent"><img alt="Return to IMDC website" src="../Templates/TemplateFiles/iMdc.gif" alt="IQP Teams" name="IQP Teams" width="150" height="25" border="0" id="IQPTeams" onload="" ></a></td>';
		...
		var newtd = document.createElement("TR");
		var toLados = document.createElement("TD");
		img = '<img src="Templates/TemplateFiles/iMdc.gif" alt="IQP Teams" name="IQP Teams" width="193" height="50" border="0" id="IQPTeams" onload="" >'
